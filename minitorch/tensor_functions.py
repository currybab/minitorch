...
class Sigmoid(Function):
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        ...
        return grad_output.f.mul_zip(grad_output.f.mul_zip(sig, sig.f.add_zip(sig.f.inv_map(sig), tensor([1.0]))), grad_output)
...
class Permute(Function):
    ...
    def forward(ctx: Context, a: Tensor, order: Tensor) -> Tensor:
        ...
        return minitorch.Tensor.make(a._tensor._storage, tuple(a.shape[i] for i in order.to_numpy()), backend=a.backend)
